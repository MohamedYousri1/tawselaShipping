...
addCompanyWall(id)
{
  return this.http.get(`https://tawsela-backend.innovations-eg.com/api/dashboard/company_detail/${id}`)
}


afterZeroWallet(id)
{
  return this.http.get(`https://tawsela-backend.innovations-eg.com/api/dashboard/account_detail/${id}`)
}

clearWallet (data : any )
{
  return this.http.post(`https://tawsela-backend.innovations-eg.com/api/dashboard/company-account` , data)
}
