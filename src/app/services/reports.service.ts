...
export class ReportsService {
  ...
  get_allCustomers()
  {
    return this.http.get(`https://tawsela-backend.innovations-eg.com/api/dashboard/user/individuals`) ;
  }
  getAllCompanies()
  {
    return this.http.get(`https://tawsela-backend.innovations-eg.com/api/dashboard/user/companies`) ;
  }
  sendDate(data)
  {
    return this.http.post(`https://tawsela-backend.innovations-eg.com/api/dashboard/statistics/getUserShipmentSNumberInterval` , data)
  }
