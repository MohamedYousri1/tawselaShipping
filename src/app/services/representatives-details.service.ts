...
export class RepresentativesDetailsService {
  ...
  {
    return this._HttpClient.get(`https://tawsela-backend.innovations-eg.com/api/dashboard/details_account_representative/${id}`)
  }


  afterZeroWallet(id)
  {
    return this._HttpClient.get(`https://tawsela-backend.innovations-eg.com/api/dashboard/account_detail_representative/${id}`)
  }

  clearWallet (data : any )
  {
    return this._HttpClient.post(`https://tawsela-backend.innovations-eg.com/api/dashboard/representative_account` , data)
  }
