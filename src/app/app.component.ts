...
@Component({
  ...
  is_company : boolean  = false ;
    ...
    {
      debugger
      this._http.get(`https://tawsela-backend.innovations-eg.com/api/dashboard/all-notification_company`).subscribe((res  : any ) =>  {
   ...
   getUserNotification()
   {
    ...
    if(localStorage.getItem('employee'))
    {
      ...
      debugger
      this._http.get(`https://tawsela-backend.innovations-eg.com/api/dashboard/all-notification_company`,{headers : {skip:"true"}}).subscribe((res : any) =>  {
        this.counter  = [] ;
        // debugger
        this.allNotifications = res.notification_company ;
   ...
   fillData : boolean =  false ;
    watchUsersNotify(modal  , notifyId)
    {
      ...
      // debugger
      this._http.get(`https://tawsela-backend.innovations-eg.com/api/watchUsersNotification/${notifyId.id}` , {headers : {skip:"true"}}).subscribe(res =>  {
        // console.log(res);
