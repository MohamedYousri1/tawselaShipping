...
import { ShipmentPlacesService } from './../../services/shipment-places.service';
import { ShipmentTypesService } from './../../services/shipment-types.service';
import { ReceiveStatusesService } from './../../services/receive-statuses.service';
...
@Component({
  ...
  selector: 'app-edit-add-ship-com',
  templateUrl: './edit-add-ship-com.component.html',
  styleUrls: ['./edit-add-ship-com.component.css']
})
export class EditAddShipComComponent implements OnInit {
  myform!: FormGroup;
  myform1! : FormGroup;
  myform2! : FormGroup;
  myform3! : FormGroup;
  ...
  catchObj()
{
  ...
  add()
  {
    ...
    this.formDataToSend.append('shipment_status_id' , "1") ;
    ...
    return this.ships_ser.create_shipmentCom(this.formDataToSend).subscribe(res =>  {
      console.log(res);
  ...
  edit(id :any )
  {
    ...
    debugger
    return this.ships_ser.edit_shipmentCompany(this.formDataToSend , id).subscribe(res =>  {
      console.log(res);
  ...
  after() {
    this.ships_ser.getAllShipmentsForcompany(true  , '' ).subscribe(
      res=>{
        this.newData.emit(res.shipment.data)
      }
    )
  }
