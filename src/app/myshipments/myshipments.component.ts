...
export class MyshipmentsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.get_nowShipments(`https://tawsela-backend.innovations-eg.com/api/dashboard/shipment-current`) ;
  }
  ...
  //Editing  ;
  refresh() {
    this.get_nowShipments('https://tawsela-backend.innovations-eg.com/api/dashboard/shipment-send') ;
  }
